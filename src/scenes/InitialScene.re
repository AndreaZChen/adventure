...
type state = {charactersSpokenSequence: list(Character.pair)};

let initialState = {charactersSpokenSequence: []};
...
let reducer =
    ...
    ReactUpdate.UpdateWithSideEffects(
      {
        charactersSpokenSequence:
          Belt.List.add(state.charactersSpokenSequence, StielettaAnethir),
      },
      _self => {
        scrollToTop();
        None;
  ...
  | SpeakAnethirJaziel =>
    ReactUpdate.UpdateWithSideEffects(
      {
        charactersSpokenSequence:
          Belt.List.add(state.charactersSpokenSequence, AnethirJaziel),
      },
      _self => {
        scrollToTop();
        None;
  ...
  | SpeakJazielStieletta =>
    ReactUpdate.UpdateWithSideEffects(
      {
        charactersSpokenSequence:
          Belt.List.add(state.charactersSpokenSequence, JazielStieletta),
      },
      _self => {
        scrollToTop();
        None;
...
camp, the moon's rays pierce the canopy of leaves above. The warm glow of the campfire bathes them in a dim but cozy light."
      ...
      let narration2 =
        <>
          <br />
          <Text character=Stieletta> "Stieletta Goldenheel" </Text>
          <Text>
...
She almost looks like she's sleeping, but occasionally an eye flits open to stare at her companions."
      ...
      let narration3 =
        <>
          <br />
          <Text character=Jaziel> "Jaziel" </Text>
          <Text>
...
though; his eyes are drawn to the spiral parchment-book his friend is intently leafing through."
      ...
      let narration4 =
        <>
          <br />
          <Text character=Anethir> "Anethir" </Text>
          <Text>
...
thinking hard."
      ...
      <>
        narration0
        <FadeInDiv fadeInTime=1000> narration1 </FadeInDiv>
        <FadeInDiv fadeInTime=1500 startFadeInAt=1000> narration2 </FadeInDiv>
        <FadeInDiv fadeInTime=2000 startFadeInAt=1500> narration3 </FadeInDiv>
        <FadeInDiv fadeInTime=2500 startFadeInAt=2000> narration4 </FadeInDiv>
      </>;
    };
  };
...
"Will you please put down your book of|js}
           ...
           <Text italicize=true> {js| foul magics?"|js} </Text>
           <Text>
...
"Highly doubt it," Anethir replies flatly. They hold up the notebook for Jaziel to read. "D'you see this symbol here?" They tap on a small scribble in the center of the page. "I've almost got this thing figured out, but this one's weird. It's right there in the center, but it's so |js}
           ...
           <Text italicize=true> "simple," </Text>
           <Text>
...
"Yes!!" Anethir exclaims. "That! is the whole point!! We don't know what we're going to find, but we're going to |js}
           ...
           <Text italicize=true> {js|find out|js} </Text>
           <Text>
...
An awkward silence. The rustling of leaves in the wind and the faint crackling of the fire somehow feel overwhelmingly loud.|js}
       ...
       | [JazielStieletta] =>
         <FadeInDiv fadeInTime=2000>
           ...
           <Text italicize=true> {js|some|js} </Text>
           <Text>
...
"You should try lying down, Stieletta. It's more comfortable |js}
           ...
           <Text italicize=true> {js|and|js} </Text>
           <Text>
...
"Maybe I should," she finally says. "Perhaps just this once, I'll..."|js}
       ...
       | [AnethirJaziel, JazielStieletta] =>
         <FadeInDiv fadeInTime=2000>
           <Text>
             {js|"Oh, I know this one!" says Anethir, looking up from their notebook.
...
"Much obliged, An," says Jaziel, still strumming on his lute. "I'll return the favor next time you mess with her."|js}
       ...
       | [_interaction1, _interaction2, _interaction3, ..._] =>
         <>
           <FadeInDiv fadeInTime=2000>
             <Text> {js|Suddenly, the forest erupts into fire.|js} </Text>
           </FadeInDiv>
           <br />
...
"So," |js}
             ...
             <Text npc=Euporie> {js|a voice says|js} </Text>
             <Text>
